...
#
# @modified by Haoyang Liu, 2021.02.14
#
###
#
...
# we test a cblas function with the lapack libraries found and set CBLAS
...
if (BLAS_FOUND)
  ...
  if (NOT CBLAS_STANDALONE)
    ...
    if(CBLAS_WORKS)
      ...
      # find cblas.h
      # not an error if cblas.h is not found.
      unset(_inc_dir CACHE)
      find_path(_inc_dir
          NAMES cblas.h
          PATH_SUFFIXES include openblas/include OpenBLAS openblas
          HINTS "${CMAKE_PREFIX_PATH}")
      if (_inc_dir)
          set(CBLAS_INCLUDE_DIRS "${_inc_dir}")
          set(CBLAS_INCLUDE_DIRS_DEP "${_inc_dir}")
      else()
          message(WARNING "cblas.h not found in default location. Please set CFLAGS/CXXFLAGS when compiling")
          set(CBLAS_INCLUDE_DIRS "${BLAS_INCLUDE_DIRS}")
          set(CBLAS_INCLUDE_DIRS_DEP "${BLAS_INCLUDE_DIRS}")
      endif()
      # linker flags
  ...
  if (CBLAS_STANDALONE OR NOT CBLAS_WORKS)
    ...
    if(NOT CBLAS_WORKS AND NOT CBLAS_FIND_QUIETLY)
      message(STATUS "Looking for cblas : test with blas fails, switch to standalone cblas")
    endif()
    ...
    if(CBLAS_LIBRARIES)
      ...
      if(CBLAS_WORKS)
        ...
        if(NOT CBLAS_FIND_QUIETLY)
          message(STATUS "Looking for cblas: test of cblas_dgemm with cblas and blas libraries fails")
